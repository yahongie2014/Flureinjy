                ...
                <option value="crazy">crazy</option>
                        ...
                        <div class="panel mb35">
                            ...
                            <div class="panel-body br-t">
                                <div class="allcp-form theme-primary">
                                    <div class="col-sm-4 ">
                                        <input type="submit" class="btn btn-lg btn-block btn-success" value="{{trans('admin.add_expenses')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="submit" name="another" class="btn btn-lg btn-block btn-primary" value="{{trans('admin.add_another_expense')}}">
                                    </div>
                                    <div class="col-sm-4 ">
