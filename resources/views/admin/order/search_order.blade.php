                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="filter-datepicker" class="field prepend-picker-icon">
                                <input type="text" value="11/01/2015" id="filter-datepicker" name="filter-datepicker" class="gui-input" placeholder="{{trans('admin.filter_by_date')}}">
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="field select">
                                <select id="filter-status" name="filter-status">
                                    <option value="" selected disabled>{{trans('admin.filter_by_status')}}
                                    <option value="1">Pending
                                    <option value="2">Canceled
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group text-right">
                                            <button type="button" class="btn btn-primary br2 btn-xs fs12 dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> Completed
                                    ...
                                    <td class="text-center">
                                        <a href="" class="btn btn-info br2 btn-xs"> Edit</a>
                                    </td>
                                </tr>
                            @endforeach
