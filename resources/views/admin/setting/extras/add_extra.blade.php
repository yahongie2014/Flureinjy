...
@section('content')
    <script>
        ...
        function addMoreRows(frm) {
            rowCount ++;
            var santos = $('#extradata').val();
            var extras = santos.toString();
            jQuery('#kamatcho').val(extras);
            if(extras.length==0){
                alert('You Must Enter Some Data')
            }else {

                var recRow = '<tr id="rowCount' + rowCount + '"> <td> ' + extras + '</td> <td> <a href="javascript:void(0);" onclick="removeRow(' + rowCount + ');">Remove</a> </td><td><input type="hidden"  name="type[]" value="' + extras + '"/> </td> </tr> ';
                                ...
                                <div id="tab15_1" class="tab-pane active">
                                    ...
                                    <div class="section row mb10">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-9 ph10">
                                                <input type="text" name="name" id="" class="gui-input" placeholder="{{trans('admin.extra_name')}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section row mb10">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-9 ph10">
                                                <input type="text" name="order_type" id="extradata" class="gui-input" placeholder="{{trans('admin.extra')}} {{trans('admin.type')}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <a  onclick="addMoreRows(this.form)" class="btn btn-info br2 btn-m"> <i class="fa fa-plus"></i>{{trans('admin.add_type')}}</a>
                                        </div>
                                    </div>
