...
@section('content')
        ...
        <div class="panel mb35">
            ...
            <div class="panel-body br-t">
                <div class="allcp-form theme-primary">
                    {!! Form::open(['url'=>'order_type/edit/'.$order_type->id]) !!}
                                ...
                                <div id="tab15_1" class="tab-pane active">
                                    ...
                                    <div class="section row mb10">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-9 ph10">
                                                <input type="text" name="order_type" value="{{$order_type->order_type}}" id="" class="gui-input" placeholder="{{trans('admin.order_type_name')}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section row mb10">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-9 ph10">
                                                <input type="text"  id="order_option"  class="gui-input" placeholder="{{trans('admin.order_option')}} ">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="table-responsive">
                                                <table class="table allcp-form theme-warning tc-checkbox-1 fs13 table-hover">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $options = explode(',', $order_type->options);
                                                    ?>
                                                    @for($i=0; $i<count($options); $i++)
                                                        <tr id="extra_type{{$i}}" class="text-center" >
                                                            <td>
                                                                {{$options[$i]}}
                                                                <input type="text"  name="option_value[]" value="{{$options[$i]}}">
                                                            </td>
    ...
    <script>
        ...
        function addMoreRows(frm) {
            ...
            var recRow = '<tr id="rowCount'+rowCount+'"> <td> '+option+' <input type="text" name="option_value[]" value='+option+' "></td> <td> <a href="javascript:void(0);" onclick="removeRow('+rowCount+');">Remove</a> </td> </tr> ';
            jQuery('tbody').append(recRow);
        }
