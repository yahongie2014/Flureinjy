        ...
        <div class="chute chute-center">
            ...
            <div class="mw1000 center-block">
                ...
                <div class="allcp-form">
                    {!! Form::open(['url'=>'edit_user/'.$user->id]) !!}
                        ...
                        <div class="panel-body br-t">
                                ...
                                <div class="col-md-12">
                                    <div class="section">
                                        <label class="field prepend-icon">
                                            <input type="text" value="{{$user->full_name}}" name="full_name" id="full_name" class="gui-input" placeholder="{{trans('admin.full_name')}}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section">
                                        <label class="field prepend-icon">
                                            <input type="text" value="{{$user->name}}" name="name" id="name" class="gui-input" placeholder="{{trans('admin.user_name')}}">
                                            <label for="name" class="field-icon">
                                                <i class="fa fa-user"></i>
                                            </label>
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section">
                                        <label class="field prepend-icon">
                                            <input type="email" value="{{$user->email}}" name="email" id="email" class="gui-input" placeholder="{{trans('admin.email')}}">
